    ...
    return (
        <>
            {(art && artist) ?
                ...
                <div className="row">
                    <div className="main col-lg-8 col-md-12" style={{ border: "1px white solid" }}>
                        <div className="row" style={{width:"100%"}}>
                            <div className="imageInfo col-12" style={{ border: "1px white solid" }}>
                            ...
                            <div className="commentSection col-12" style={{ border: "1px white solid" }}>
                    ...
                    <div className="side col-lg-4 col-md-12" style={{ border: "1px white solid" }}>
                        <div className="row" style={{ width: "100%" }}>
                            <div className="moreByAuthor col-12" style={{ border: "1px white solid" }}>
                                <h4>
                            ...
                            <div className="categories col-12" style={{ border: "1px white solid" }}>
                                RIGHT-BOTTOM
                            </div>
                        </div>
                    </div>
